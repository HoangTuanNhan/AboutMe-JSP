		...
		<div>
			...
			<ul>
				<%
                    ...
                    %>
				<li <%=setActiveHome %>>
					<a href="<%=request.getContextPath()%>/trang-chu.html">Trang chủ</a>
				</li>
				<li  <%=setActiveAboutMe %>>
					<a href="<%=request.getContextPath()%>/gioi-thieu.html">Giới thiệu</a>
				</li>
				<li <%=setActiveProject %>>
					<a  href="<%=request.getContextPath()%>/du-an.html">Dự án thực hiện</a>
				</li>
				<li <%=setActiveThanhVien %>>
					<a href="<%=request.getContextPath()%>/thanhvien">Thành viên</a>
				</li>
				<li <%=setActiveNews %>>
					<a href="<%=request.getContextPath()%>/tin-tuc.html">Tin tức</a>
				</li>
				<li <%=setActiveContact %>>
					<a  href="<%=request.getContextPath() %>/lien-he.html">Liên hệ</a>
				</li>
			</ul>
		</div>
	</div>