...
<%@include file="/templates/public/inc/header.jsp" %>
	<div id="body">
		<div class="content">
			<div id="section">
				<h2>Liên hệ với Tuấn Nhân</h2>
				<img src="<%=request.getContextPath() %>/templates/public/images/eu.jpg" alt="" style="width: 573px;height: 301px;" />
				<form action="<%=request.getContextPath()%>/contact">
					<b>Gửi liên hệ trực tuyển</b> 
					<span>Vui lòng điền đầy đủ thông tin để liên hệ trực tuyến đến Tuấn Nhân. Tôi sẽ phản hồi sớm nhất có thể!</span>
