...
<div class="bottom-spacing">
	  ...
	  <%
		...
		%>
		<p style="color: red; font-weight: bold">Chỉ có admin mới có thể sửa </p>
		<%
			}
		%>
		 <%
			...
			<table id="myTable" class="tablesorter">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="<%=request.getContextPath()%>/admin/editUsers?idU=<%=objUsers.getIdUsers()%>"><%=objUsers.getUsername() %></a></td>
						...
						<td align="center">
							...
							<a href="<%=request.getContextPath() %>/admin/editUsers?uid=<%=objUsers.getIdUsers()%>">Sửa <img src="<%=request.getContextPath() %>/templates/admin/images/pencil.gif" alt="edit" /></a>
							<a href="<%=request.getContextPath() %>/admin/delUsers?uid=<%=objUsers.getIdUsers()%> "onclick="return confirm('Are you sure?')">Xóa <img src="<%=request.getContextPath() %>/templates/admin/images/bin.gif" width="16" height="16" alt="delete" /></a>
						</td>
						<%}else{ %>
							<td align="center" >
