		...
		<div class="module-table-body">
			...
			<table id="myTable" class="tablesorter">
				...
				<tbody>
					...
					%>
					<tr>
						<td class="align-center"><%=objProject.getIdProject() %></td>
						<td><a href=""><%=objProject.getName() %></a></td>
						<td><%=objProject.getNguoiThucHien()%></td>
						...
						<td align="center">
							<a href="<%=request.getContextPath() %>/admin/editProject?idP=<%=objProject.getIdProject()%>">Sửa <img src="<%=request.getContextPath() %>/templates/admin/images/pencil.gif" alt="edit" /></a>
							<a href="<%=request.getContextPath() %>/admin/delProject?idP=<%=objProject.getIdProject()%>" onclick="return confirm('Are you sure?')">Xóa<img src="<%=request.getContextPath() %>/templates/admin/images/bin.gif" width="16" height="16" alt="delete" /></a>
						</td>
					</tr>
						<%}} %>
				</tbody>
