		 ...
		 <div class="module-body">
			<form
				...
				<p>
					...
					<input type="text" name="nguoithuchien" value="<%=oldProject.getNguoiThucHien() %>" class="input-medium" required pattern="^[\s a-zA-Z_ÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂĐĨŨƠàáâãèéêìíòóôõùúăđĩũơƯĂẠẢẤẦẨẪẬẮẰẲẴẶẸẺẼỀỀỂưăạảấầẩẫậắằẳẵặẹẻẽềềểỄỆỈỊỌỎỐỒỔỖỘỚỜỞỠỢỤỦỨỪễệỉịọỏốồổỗộớờởỡợụủứừỬỮỰỲỴÝỶỸửữựỳỵỷỹ]+$" />
				</p>
				<p>
					<label>Mô tả</label>
				...
				<p>
					...
					<label><a href="<%=request.getContextPath()%>/admin/editProject?idP=<%=oldProject.getIdProject()%>&type=load&delImage=true" class="button">
